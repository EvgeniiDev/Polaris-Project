...
namespace ExchangeFakerTests
{
    ...
    {
        private IExchange fakePrice;
        private ExchangeFaker.ExchangeFaker exchange;
        ...
        public void SetUp()
        {
            var mock = new Mock<IExchange>();
            mock.Setup(x => x.GetPrices())
                    .Returns(Task.Run(()=>prices));

            fakePrice = mock.Object;
            exchange = new ExchangeFaker.ExchangeFaker(fakePrice);
        }
        ...
        public void JustBuySomeCoins()
        {
            ...
            prices["шоколадные монетки"] = 9m;
            exchange.UpdateStates();
            prices["шоколадные монетки"] = 10m;
            exchange.UpdateStates();
            prices["шоколадные монетки"] = 11m;
            exchange.UpdateStates();
