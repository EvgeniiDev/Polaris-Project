...
namespace ExchangeFaker.Tests
{
    ...
    public class AccountTests
    {
        ...
        public void JustBuySomeCoins()
        {
            ...
            var order = account.PostMarketOrder(OrderType.BuyLimit, "шоколадные монетки", buy);
        ...
        public void BuySomeCoinsWhenNotEnoughMoneys()
        {
            ...
            Assert.Catch(
                delegate
                {
                    ...
                    var order = account.PostMarketOrder(OrderType.BuyLimit, tickerName, buy);
                });
        ...
        public void BuySomeCoinsAndSellAllByTakes()
        {
            ...
            var order = account.PostMarketOrder(OrderType.BuyLimit, tickerName, buy, take);
        ...
        public void BuySomeCoinsAndSellPartByStop()
        {
            ...
            var order = account.PostMarketOrder(OrderType.BuyLimit, tickerName, buy, null, stop);
            var priceGoals = new List<decimal>() { 9m, 10m, 11m, 8m };
            MovePrice(priceGoals, tickerName);
            Assert.AreEqual(Status.Open, account.Orders[order].Status);
            Assert.AreEqual(75m, account.Orders[order].Amount);
        ...
        public void BuySomeCoinsAndSellAllByTakeAndStop()
        {
            ...
            var stop = new List<Order>() { new Order(9, 25) };
            var order = account.PostMarketOrder(OrderType.BuyLimit, tickerName, buy, take, stop);
